<script>
    jQuery(document).ready(function($) {
        ...
        function load_content() {
            ...
            */
            $.ajax({
                url: "{{ route('class_ws_answer_pullcontent', [$cid, $wsname]) }}",
                method: 'get',
                data: {
                    _token: CSRF_TOKEN,
                },
                success: function(result) {
                    if(result.status == "error"){
                        ...
                        window.location.href = "{{ route('class_stats', [$cid]) }}";
                    } else {
        ...
        function submit_A() {
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    if (result == "Y") {
                        window.location = "{{ route('class_ws_postanswer', [$cid, $wsname]) }}"
                    } else {
